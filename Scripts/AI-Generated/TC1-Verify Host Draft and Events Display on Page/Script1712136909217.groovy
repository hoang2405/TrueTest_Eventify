...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events/hyperlink_host_draft_draft_test_n_a_n_a_dung'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/hyperlink_host_draft_draft_test_n_a_n_a_dung'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Host Draft and Events Display on Page_visual_checkpoint')
