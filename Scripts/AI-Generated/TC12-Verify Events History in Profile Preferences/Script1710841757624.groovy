...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events/p_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/p_object'))
...
"Step 8: Click on link 'Profile' -> Navigate to page 'profile/*'"
...
"Step 9: Click on p  -> Navigate to page 'profile/*/preference'"
...
"Step 10: Click on span  -> Navigate to page 'profile/*/preference/events-history'"
