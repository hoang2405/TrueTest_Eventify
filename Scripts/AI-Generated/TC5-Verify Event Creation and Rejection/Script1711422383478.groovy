...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events/button_reject_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/button_reject_1'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Event Creation and Rejection_visual_checkpoint')
