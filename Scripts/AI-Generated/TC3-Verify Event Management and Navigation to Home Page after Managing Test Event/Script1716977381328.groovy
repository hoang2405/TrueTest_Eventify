...
"Step 7: Click on div 'rc-tabs-0-tab-1'"

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/div_notifyViaEmail'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/span_notifyViaEmailAll'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Event Management and Navigation to Home Page after Managing Test Event_visual_checkpoint')
