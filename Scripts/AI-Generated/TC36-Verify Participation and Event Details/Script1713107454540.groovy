...
"Step 6: Click on link 'Copied of true test 01' -> Navigate to page 'events/*'"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events/div_object_24'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/div_object_24'))

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC36-Verify Participation and Event Details_visual_checkpoint')
