...
"Step 7: Click on button 'Submit' -> Navigate to page 'events/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Verify Event Submission Confirmation Process_visual_checkpoint')
