import katalon.common.submitPublishAndApproveEvents
import static com.kms.katalon.core.testobject.ObjectRepository.findTestObject
import katalon.common.clickObjectsToFillCheckoutFormAndComplete
import com.kms.katalon.core.model.FailureHandling
import katalon.common.saveDraftResumeAndFillActivityDetails
import internal.GlobalVariable as GlobalVariable
import katalon.truetest.TrueTestScripts
import katalon.common.submitPublishCheckinAndManageEvents
import katalon.common.discardAndCreateEventOnProfileEventsHistory
import katalon.common.saveDraftResumeAndFillEventDetails
import com.kms.katalon.core.webui.keyword.WebUiBuiltInKeywords as WebUI
import katalon.common.viewAndInputObjectDetails
import katalon.common.discardAndCreateEventOnEventsPage
import katalon.common.openEventsPageAndCreateEvent
...
clickObjectsToFillCheckoutFormAndComplete.execute()

"Step 10: Call functional action"

WebUI.takeScreenshot()

submitPublishCheckinAndManageEvents.execute()

"Step 11: Call functional action"

WebUI.takeScreenshot()

openEventsPageAndCreateEvent.execute()
...
discardAndCreateEventOnEventsPage.execute()
...
discardAndCreateEventOnProfileEventsHistory.execute()
...
saveDraftResumeAndFillEventDetails.execute()
...
saveDraftResumeAndFillActivityDetails.execute(data_path_0, Integer.valueOf(index_0))
...
viewAndInputObjectDetails.execute()
...
saveDraftResumeAndFillActivityDetails.execute(data_path_1, Integer.valueOf(index_1))

"Step 68: Call functional action"

WebUI.takeScreenshot()

submitPublishAndApproveEvents.execute()

"Step 69: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Event Creation and Management Workflow_visual_checkpoint')
