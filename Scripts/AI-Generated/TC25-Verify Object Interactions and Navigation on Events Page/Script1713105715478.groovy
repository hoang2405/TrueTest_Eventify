...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events/div_object_19'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/div_object_19'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC25-Verify Object Interactions and Navigation on Events Page_visual_checkpoint')
