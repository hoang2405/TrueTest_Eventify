...
"Step 3: Click on button 'Administrative \u2192' -> Navigate to page 'events/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Verify Event Rejection_visual_checkpoint')
