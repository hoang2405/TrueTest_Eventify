...
import katalon.common.manageEventDetailsAndNotifications
...
"Step 6: Manage event details and notifications"

WebUI.takeScreenshot()

manageEventDetailsAndNotifications.execute()
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC50-Verify Event Creation and Form Submission_visual_checkpoint')
