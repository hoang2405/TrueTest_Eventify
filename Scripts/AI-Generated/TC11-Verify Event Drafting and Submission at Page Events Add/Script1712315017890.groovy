...
import katalon.common.clickSaveAsDraftResumeAndInputDetails
import katalon.common.clickSaveAsDraftResumeSubmitPublishApproveAndInputDetails
import katalon.common.clickSubmitPublishApproveAndInputDetails
import internal.GlobalVariable as GlobalVariable
import katalon.common.clickInputDetails
import katalon.truetest.TrueTestScripts
import katalon.common.clickSaveAsDraftResumeSubmitAndInputDetails
import katalon.common.clickMyEventsAllAndInputDetails
import katalon.common.clickSubmitPublishApproveCheckinFinishAndInputDetails
import com.kms.katalon.core.webui.keyword.WebUiBuiltInKeywords as WebUI
import katalon.common.clickCreateEventAndInputDetails
import katalon.common.clickSubmitTimelineManageEditNotifyDeleteAndInputDetails
import static com.kms.katalon.core.testobject.ObjectRepository.findTestObject
import katalon.common.clickDiscardCreateEventAndInputDetails
...
clickSubmitPublishApproveCheckinFinishAndInputDetails.execute()

"Step 10: Call functional action"

WebUI.takeScreenshot()

clickSubmitTimelineManageEditNotifyDeleteAndInputDetails.execute()

"Step 11: Call functional action"

WebUI.takeScreenshot()

clickCreateEventAndInputDetails.execute()
...
clickDiscardCreateEventAndInputDetails.execute()
...
clickSaveAsDraftResumeAndInputDetails.execute()

"Step 24: Call functional action"

WebUI.takeScreenshot()

clickSaveAsDraftResumeSubmitPublishApproveAndInputDetails.execute()

"Step 25: Call functional action"

WebUI.takeScreenshot()

clickSaveAsDraftResumeSubmitAndInputDetails.execute(data_path_0, Integer.valueOf(index_0))
...
clickMyEventsAllAndInputDetails.execute()
...
clickSaveAsDraftResumeAndInputDetails.execute(data_path_1, Integer.valueOf(index_1))

"Step 68: Call functional action"

WebUI.takeScreenshot()

clickSubmitPublishApproveAndInputDetails.execute()

"Step 69: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Event Drafting and Submission at Page Events Add_visual_checkpoint')
