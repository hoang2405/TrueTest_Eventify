...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events/span_object_4'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_events/span_object_4'))
...
"Step 11: Click on button 'Participation'"
...
"Step 12: Click on button 'Checkin' -> Navigate to page 'events'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Verify Multi step Participation Process on Events Page_visual_checkpoint')
