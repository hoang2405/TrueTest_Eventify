...
WebUI.setText(findTestObject('AI-Generated/Page_events/input_object_10'), input_object)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Event Page Interaction_visual_checkpoint')
