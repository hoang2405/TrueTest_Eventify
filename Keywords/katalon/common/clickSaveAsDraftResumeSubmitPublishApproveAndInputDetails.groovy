...
public class clickSaveAsDraftResumeSubmitPublishApproveAndInputDetails {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.takeScreenshot()
        WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_events_drafts/input_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)
        WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/events/drafts/.*?/?(?:#.*)?(?:\\?.*)?$', true)
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_events_drafts/input_object'))
        "Step 7: Click on div"
        WebUI.takeScreenshot()
